...
class Co_Multihead_attention(nn.Module):

    def __init__(self, self_attn, embed_dim, num_heads, qdim=None, kdim=None, vdim=None,
                 dropout=0., bias=True, keep_rate=0.60):
        super(Co_Multihead_attention, self).__init__()
    ...
    def forward(self, query, key=None, value=None, key_padding_mask=None, attn_mask=None):
        ...
        Q = Q * self.scaling
        #contiguous() is used to make sure the memory is continuous,return a contiguous tensor
...
class FFMEncoder(nn.Module):
    def __init__(self, self_attn, embed_dim, qdim=None, kdim=None, ffn_embed_dim=2304, num_heads=8,
        ...
        self.attention = Co_Multihead_attention(self_attn, embed_dim, num_heads, qdim, kdim, kdim, attention_dropout)
...
class FFM_block(nn.Module):

    def __init__(self, self_attn, num_layers, embed_dim, qdim=None, kdim=None, ffn_embed_dim=2304, num_heads=8, dropout=0.1,
        ...
        self.layers = nn.ModuleList([FFMEncoder(self_attn, embed_dim, qdim, kdim, ffn_embed_dim, num_heads,
...
def build_FFM_block(self_attn, num_layers, embed_dim, qdim=None, kdim=None, ffn_embed_dim=2304, num_heads=8, dropout=0.1, attention_dropout=0.1, activation='gelu'):
    ...
    return FFM_block(self_attn, num_layers, embed_dim, qdim, kdim, ffn_embed_dim, num_heads, dropout, attention_dropout, activation)
